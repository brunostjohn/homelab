...

{
  ...
  environment.variables = {
    K3S_NODE_NAME = "s5.m-nodes.zefirscloud.local";
  };

  boot.kernel.sysctl."kernel.hostname" = "s5.m-nodes.zefirscloud.local";
  ...
  systemd.network.links."10-lan" = {
    matchConfig.PermanentMACAddress = "bc:24:11:b8:f7:09";
