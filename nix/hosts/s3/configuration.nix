...

{
  ...
  environment.variables = {
    K3S_NODE_NAME = "s3.m-nodes.zefirscloud.local";
  };

  boot.kernel.sysctl."kernel.hostname" = "s3.m-nodes.zefirscloud.local";
  ...
  systemd.network.links."10-lan" = {
    matchConfig.PermanentMACAddress = "bc:24:11:c0:02:b1";
