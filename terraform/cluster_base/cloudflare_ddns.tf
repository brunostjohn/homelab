...
resource "kubernetes_config_map" "cloudflare_ddns" {
  ...
  data = {
    domains = "${var.global_fqdn},*.${var.global_fqdn},*.static.${var.global_fqdn},corner.${var.global_fqdn},cubes.${var.global_fqdn},carrier.${var.global_fqdn},*.envs.${var.global_fqdn},${var.second_fqdn},*.${var.second_fqdn}"
